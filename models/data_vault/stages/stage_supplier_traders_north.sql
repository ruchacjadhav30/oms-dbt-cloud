...
SELECT
    ...
    ) AS dss_change_hash_supplier_hroc_traders_north,
    ...
    ) AS dss_change_hash_supplier_lroc_traders_north,
    ...
    ) AS dss_change_hash_supplier_mroc_traders_north,
...
FROM {{ source('sleekmart_raw', 'LOAD_SUPPLIERS_TRADERS_NORTH') }}